...
const EN = {
  ...
  testDataNote: 'Test data — real stats will be generated from the 26.16 patch pipeline.',
  rank: 'Rank',
  lp: 'LP',
  level: 'Lv',
  wins: 'W',
...
const ES = {
  ...
  testDataNote: 'Datos de prueba: las estadísticas reales vendrán del pipeline del parche 26.16.',
  rank: 'Rank',
  metricGold: 'Oro',
  metricDamage: 'Daño',
  metricXp: 'XP',
