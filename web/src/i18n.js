...
const EN = {
  ...
  evAll: 'All',
  evKills: 'Kills',
  evObjectives: 'Objectives',
  evBuildings: 'Buildings',
  ...
  evTeamBlue: 'BLUE',
  evTeamRed: 'RED',
  evEmpty: 'No events match the current filter',
  evMinute: 'min',
  tabLive: 'Live game',
  liveNow: 'IN GAME',
  liveBans: 'Bans',
  ...
  metricObj: 'Objectives',
  metricBuild: 'Buildings',
  minShort: 'min',
...
const ES = {
  ...
  evAll: 'Todo',
  evKills: 'Bajas',
  evObjectives: 'Objetivos',
  evBuildings: 'Estructuras',
  ...
  evTeamBlue: 'AZUL',
  evTeamRed: 'ROJO',
  evEmpty: 'No hay eventos con este filtro',
  evMinute: 'min',
